...
export default function Home({}: Props) {
  return (
    ...
    <Head>
          ...
          <meta name="description" content='У вас есть возможность получить знания у квалифицированных преподавателей в области изучения Священного писания и, тем самым, стать носителями Корана.' />
